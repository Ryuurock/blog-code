...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wxRouterMapping__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_constants__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contentScript_mixin__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pageEventHandler__ = __webpack_require__(46);
...
location.hostname === 'mp.weixin.qq.com' && function () {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_2__contentScript_mixin__["a" /* onMessageFromBackground */])('sendMessageToFrameContentScript', function ({ event, data }) {
    __WEBPACK_IMPORTED_MODULE_3__pageEventHandler__["a" /* default */][event] && __WEBPACK_IMPORTED_MODULE_3__pageEventHandler__["a" /* default */][event](data);
  });
  ...
  // 对每次微信frame的跳转进行响应
  $(function () {
    let result = Object(__WEBPACK_IMPORTED_MODULE_0__wxRouterMapping__["a" /* default */])(location);
  ...
  document.body.addEventListener('extensionPageEventFromFrame', function () {
    sendMessageToPage({
      event: 'xhr',
      platform: 'wechat',
      data: JSON.parse($(`#${__WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* dataMiddleDomId */]}`).val())
    });
  }, false);
  ...
  $(`<textarea style="display: none" id="${__WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* dataMiddleDomId */]}"></textarea>`).appendTo(document.body);
}();
